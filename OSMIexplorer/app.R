...
# load shiny specific packagespackages
library(shiny)
...
server <- function(input, output, session) {
  ...
  shinyalert(
    ...
    text = "This explorer is meant to help users make sense of Open Sourcing Mental Illness' survey data on the tech industry from 2019. It allows you to identify questions of interest, find questions with non-sparse responses quickly, and then build visualizations based on variables in the survey that can help you make sense of the data. If this is your first time using the explorer, please click the 'tour' button on the top left for more information on the workflow."
  )
